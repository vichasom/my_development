            ...
            $.each(this.options.jsonConfig.attributes, function () {
                ...
                if (item.code == "admire_gender") {
                    ...
                    container.append(
                        ...
                        '<div class="' + classes.attributeOptionsWrapper + ' clearfix">' + options + select + '<a href="' + colors_url + '" class="colors-explained">Colors explained</a></div>' + input + '</div>'
                    );
